...
def f_args_parsed(argument_input = None):
    ...
    parser.add_argument('--module-config', type=str, default="config2", 
                        help=mes)
    ...
    parser.add_argument('--num-workers', type=int, default=3, help=mes)
    ...
    #/orange/vbindschaedler/sethlayton/orange_storage/LFCCLCNN/models/0/0-trained_network.pt
    mes = 'a trained model for inference or resume training '
    parser.add_argument('--trained-model', type=str, \
                        default="/blue/vbindschaedler/sethlayton/df_trained_network.pt", help=mes + "(default: '')")
