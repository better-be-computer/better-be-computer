...
if __name__ == '__main__':
    ...
    model_tag = 'model_asv-and-librispeech-{}'.format(args.iteration)
    if args.comment:
        model_tag = model_tag + '_{}'.format(args.comment)
    model_save_path = os.path.join('SSL_Anti-spoofing/models', model_tag)
    ...
    #evaluation 
    if args.eval:
        file_eval = genSpoof_list( dir_meta='',is_train=False,is_eval=True)
